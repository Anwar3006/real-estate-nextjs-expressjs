...
-- AddForeignKey
ALTER TABLE "Property" ADD CONSTRAINT "Property_managerClerkId_fkey" FOREIGN KEY ("managerClerkId") REFERENCES "Manager"("clerkUserId") ON DELETE RESTRICT ON UPDATE CASCADE;
